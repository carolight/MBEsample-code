...
//  let x = vector_float3(m.columns.0.x, m.columns.1.x, m.columns.2.x)
//  let y = vector_float3(m.columns.0.y, m.columns.1.y, m.columns.2.y)
//  let z = vector_float3(m.columns.0.z, m.columns.1.z, m.columns.2.z)
