...
class MBERenderer: NSObject {
  ...
  private func loadModel(modelName:String) {
    ...
    */
    ...
    let attributeTexcoords = mdlVertexDescriptor.attributes[2] as! MDLVertexAttribute
    attributeTexcoords.name = MDLVertexAttributeTextureCoordinate
    mdlVertexDescriptor.attributes[2] = attributeTexcoords
